...
## Create eventssvc.pmi.org site

remove-webapppool -name "eventssvc.pmi.org"

new-webapppool -name "eventssvc.pmi.org"

Set-ItemProperty iis:\apppools\eventssvc.pmi.org -name managedRuntimeVersion -value "v4.0"

rmdir -recurse c:\inetpub\wwwroot\eventssvc.pmi.org

mkdir c:\inetpub\wwwroot\eventssvc.pmi.org

remove-website -Name "eventssvc.pmi.org"

new-website -Name "eventssvc.pmi.org" -PhysicalPath c:\inetpub\wwwroot\eventssvc.pmi.org -ApplicationPool "eventssvc.pmi.org" -Id 5015

remove-webbinding -Name "eventssvc.pmi.org" -Port 80

new-webbinding -Name "eventssvc.pmi.org" -Port 80 -HostHeader "eventssvc.candidate.pmi.org"

new-webbinding -Name "eventssvc.pmi.org" -Port 443 -HostHeader "eventssvc.candidate.pmi.org" -Protocol "https"