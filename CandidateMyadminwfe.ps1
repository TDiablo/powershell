...
new-webbinding -Name "myadmin.pmi.org" -Port 80 -HostHeader "myadmin.candidate.pmi.org"

new-webbinding -Name "myadmin.pmi.org" -Port 443 -HostHeader "myadmin.candidate.pmi.org" -Protocol "https"

Set-ItemProperty iis:\apppools\myadmin.pmi.org -name processModel -value @{userName="pmienvs\canwfeuser";password="rus4ayaJ";identitytype=3}
